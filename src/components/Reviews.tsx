    ...
    <section id="reviews" className="py-24 px-6 bg-[#0f1e2f]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            href="https://share.google/XHrfix6mTnUVvmGRB"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-white hover:bg-gray-50 text-gray-900 font-semibold px-6 py-4 rounded-2xl border border-gray-200 transition-all duration-300 hover:shadow-md hover:-translate-y-0.5 group"
          >
            ...
            <span>Schrijf een review op Google</span>
