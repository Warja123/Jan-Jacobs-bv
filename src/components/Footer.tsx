      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="tel:+3203000000" className="text-gray-500 hover:text-amber-400 text-sm transition-colors flex items-center gap-2">
              ...
              <li>
                <a href="mailto:info@janjacobsbv.be" className="text-gray-500 hover:text-amber-400 text-sm transition-colors flex items-center gap-2">
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
